        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl space-y-6">
            <h1 className={cn(
              ...
              {emergencyMode ? "SANTÉ D'" : "Santé"} <br /> <span className={cn("transition-colors", emergencyMode ? "text-red-500" : "text-secondary")}>
                {emergencyMode ? "URGENCE" : "& Services Humains"}
              </span>
            </h1>
            <p className={cn(
              ...
              {emergencyMode
                ? "TRIAGE DE MASSE ET PRIORITÉ AUX URGENCES VITALE. TOUS LES ÉTABLISSEMENTS DE SANTÉ SONT SOUS PROTOCOLE MILITAIRE."
          ...
          <div className="flex items-center gap-4 text-white">
            ...
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tighter">
                {emergencyMode ? "CENTRE DE TRIAGE" : "Urgence Médicale"}
              </h2>
              <p className="text-white/80 font-bold uppercase text-xs tracking-widest">
                {emergencyMode ? "PRIORITÉ ABSOLUE AUX BLESSÉS DE GUERRE / CATASTROPHE" : "Composer le 911 — Dispatch Médical"}
              </p>
            </div>
          </div>
