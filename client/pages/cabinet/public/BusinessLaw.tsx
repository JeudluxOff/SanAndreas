...
import { Briefcase, CheckCircle2, TrendingUp, Building2, Landmark, Gavel } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-left duration-1000">
            ...
            <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed uppercase tracking-tight max-w-2xl">
              Un conseil stratégique pour la croissance. Harrington & Cole est le partenaire juridique privilégié des entreprises de San Andreas.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            <div className="lg:col-span-7 space-y-16 animate-in fade-in slide-in-from-bottom duration-1000">
              <div className="space-y-8">
                <h2 className="text-4xl font-black text-[#0a0f18] uppercase tracking-tighter">Sécuriser votre développement économique</h2>
                <div className="w-24 h-2 bg-[#c1a461]" />
                <p className="text-lg text-slate-600 leading-relaxed">
                  Harrington & Cole accompagne les dirigeants et les institutions dans toutes les étapes de leur vie économique. Nous combinons une expertise juridique pointue avec une compréhension fine des enjeux business.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Notre cabinet intervient aussi bien en conseil pour la structuration de vos opérations qu'en contentieux pour la défense de vos intérêts commerciaux devant les tribunaux de commerce ou les instances arbitrales.
                </p>
              </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              <Card className="border-none bg-[#0a0f18] text-white p-12 rounded-[40px] shadow-2xl sticky top-32 overflow-hidden">
                ...
                <CardContent className="p-0 space-y-8 relative z-10">
                  <h3 className="text-2xl font-black uppercase tracking-tighter">Partenariat Stratégique</h3>
                  <p className="text-white/60 text-sm leading-relaxed uppercase tracking-wide">
                    Au-delà de la stricte réponse juridique, nous nous engageons aux côtés de nos clients entreprises pour les aider à atteindre leurs objectifs de croissance en toute sécurité juridique.
                  </p>
                  <div className="space-y-4 pt-4">
                    <div className="flex items-center gap-4 p-4 border border-white/10 rounded-xl bg-white/5">
                      <Building2 className="w-6 h-6 text-[#c1a461]" />
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-[#c1a461]">Conseil Corporate</p>
                        <p className="text-lg font-black">Audit Business</p>
                      </div>
                    </div>
